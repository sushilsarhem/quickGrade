...
const FetchStudents = ({assestType,teacherId}) => {
    ...
    const pullStudents = async () => {
      ...
      try {
        ...
        setMyStudents(retrievedStudentList.sort((a,b)=>(a.rollno)-b.rollno));
  
        // console.log('Fetched Students:', retrievedStudentList);
      } catch (error) {
          ...
          <FlatList
              ...
              renderItem={({ item }) => (
                <TouchableOpacity onPress={() => router.push({
                    pathname: "/(exams)/details/[enterMarksDetails]",
                    params: {
                      studentId: item.$id,
                      name: item.name,
